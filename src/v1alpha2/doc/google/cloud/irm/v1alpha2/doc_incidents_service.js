 ...
 *
 * @typedef LookupSignalRequest
 * @memberof google.cloud.irm.v1alpha2
 * @see [google.cloud.irm.v1alpha2.LookupSignalRequest definition in proto format]{@link https://github.com/googleapis/googleapis/blob/master/google/cloud/irm/v1alpha2/incidents_service.proto}
 */
const LookupSignalRequest = {
  // This is for documentation. Actual contents will be loaded by gRPC.
};
