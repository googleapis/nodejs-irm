...
describe('v1alpha2.IncidentServiceClient', () => {
    ...
    describe('createIncident', () => {
        it('invokes createIncident without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateIncidentRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Incident());
            ...
            assert((client.innerApiCalls.createIncident as SinonStub)
        ...
        it('invokes createIncident without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Incident());
            client.innerApiCalls.createIncident = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createIncident(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.IIncident|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createIncident with error', async () => {
            ...
            client.innerApiCalls.createIncident = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.createIncident(request); }, expectedError);
            assert((client.innerApiCalls.createIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getIncident', () => {
        it('invokes getIncident without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.GetIncidentRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getIncident without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Incident());
            client.innerApiCalls.getIncident = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getIncident(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.IIncident|null) => {
        ...
        it('invokes getIncident with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getIncident = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.getIncident(request); }, expectedError);
            assert((client.innerApiCalls.getIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateIncident', () => {
        it('invokes updateIncident without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.UpdateIncidentRequest());
            request.incident = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateIncident without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Incident());
            client.innerApiCalls.updateIncident = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes updateIncident with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateIncident = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.updateIncident(request); }, expectedError);
            assert((client.innerApiCalls.updateIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createAnnotation', () => {
        it('invokes createAnnotation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateAnnotationRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Annotation());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAnnotation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createAnnotation without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAnnotation(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.IAnnotation|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createAnnotation with error', async () => {
            ...
            await assert.rejects(async () => { await client.createAnnotation(request); }, expectedError);
            assert((client.innerApiCalls.createAnnotation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createTag', () => {
        it('invokes createTag without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateTagRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Tag());
        ...
        it('invokes createTag without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createTag(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ITag|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteTag', () => {
        it('invokes deleteTag without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.DeleteTagRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createSignal', () => {
        it('invokes createSignal without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateSignalRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Signal());
            client.innerApiCalls.createSignal = stubSimpleCall(expectedResponse);
            const [response] = await client.createSignal(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createSignal without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Signal());
            client.innerApiCalls.createSignal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createSignal(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ISignal|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createSignal with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createSignal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.createSignal(request); }, expectedError);
            assert((client.innerApiCalls.createSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('lookupSignal', () => {
        it('invokes lookupSignal without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.LookupSignalRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Signal());
            client.innerApiCalls.lookupSignal = stubSimpleCall(expectedResponse);
            const [response] = await client.lookupSignal(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.lookupSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes lookupSignal without error using callback', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Signal());
            client.innerApiCalls.lookupSignal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.lookupSignal(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ISignal|null) => {
        ...
        it('invokes lookupSignal with error', async () => {
            ...
            const expectedOptions = {};
            const expectedError = new Error('expected');
            client.innerApiCalls.lookupSignal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.lookupSignal(request); }, expectedError);
            assert((client.innerApiCalls.lookupSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSignal', () => {
        it('invokes getSignal without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.GetSignalRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getSignal without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Signal());
            client.innerApiCalls.getSignal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getSignal(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ISignal|null) => {
        ...
        it('invokes getSignal with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSignal(request); }, expectedError);
            assert((client.innerApiCalls.getSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSignal', () => {
        it('invokes updateSignal without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.UpdateSignalRequest());
            request.signal = {};
            request.signal.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes updateSignal without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Signal());
            client.innerApiCalls.updateSignal = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateSignal(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ISignal|null) => {
        ...
        it('invokes updateSignal with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updateSignal = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.updateSignal(request); }, expectedError);
            assert((client.innerApiCalls.updateSignal as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('escalateIncident', () => {
        it('invokes escalateIncident without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.EscalateIncidentRequest());
            request.incident = {};
            request.incident.name = '';
            const expectedHeaderRequestParams = "incident.name=";
            const expectedOptions = {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.EscalateIncidentResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.escalateIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes escalateIncident without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.EscalateIncidentResponse());
            client.innerApiCalls.escalateIncident = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.escalateIncident(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.IEscalateIncidentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes escalateIncident with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.escalateIncident = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.escalateIncident(request); }, expectedError);
            assert((client.innerApiCalls.escalateIncident as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createArtifact', () => {
        it('invokes createArtifact without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateArtifactRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Artifact());
        ...
        it('invokes createArtifact without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createArtifact(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.IArtifact|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createArtifact with error', async () => {
            ...
            await assert.rejects(async () => { await client.createArtifact(request); }, expectedError);
            assert((client.innerApiCalls.createArtifact as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateArtifact', () => {
        it('invokes updateArtifact without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.UpdateArtifactRequest());
            request.artifact = {};
        ...
        it('invokes updateArtifact with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateArtifact(request); }, expectedError);
            assert((client.innerApiCalls.updateArtifact as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteArtifact', () => {
        it('invokes deleteArtifact without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.DeleteArtifactRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteArtifact with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteArtifact(request); }, expectedError);
            assert((client.innerApiCalls.deleteArtifact as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('sendShiftHandoff', () => {
        it('invokes sendShiftHandoff without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SendShiftHandoffRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SendShiftHandoffResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.sendShiftHandoff as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes sendShiftHandoff without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SendShiftHandoffResponse());
            client.innerApiCalls.sendShiftHandoff = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.sendShiftHandoff(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ISendShiftHandoffResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes sendShiftHandoff with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.sendShiftHandoff = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.sendShiftHandoff(request); }, expectedError);
            assert((client.innerApiCalls.sendShiftHandoff as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createSubscription', () => {
        it('invokes createSubscription without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateSubscriptionRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Subscription());
        ...
        it('invokes createSubscription without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSubscription(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.ISubscription|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('updateSubscription', () => {
        it('invokes updateSubscription without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.UpdateSubscriptionRequest());
    ...
    describe('deleteSubscription', () => {
        it('invokes deleteSubscription without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.DeleteSubscriptionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createIncidentRoleAssignment', () => {
        it('invokes createIncidentRoleAssignment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CreateIncidentRoleAssignmentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.createIncidentRoleAssignment = stubSimpleCall(expectedResponse);
            const [response] = await client.createIncidentRoleAssignment(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createIncidentRoleAssignment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createIncidentRoleAssignment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.createIncidentRoleAssignment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createIncidentRoleAssignment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.IIncidentRoleAssignment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createIncidentRoleAssignment with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createIncidentRoleAssignment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.createIncidentRoleAssignment(request); }, expectedError);
            assert((client.innerApiCalls.createIncidentRoleAssignment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteIncidentRoleAssignment', () => {
        it('invokes deleteIncidentRoleAssignment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.DeleteIncidentRoleAssignmentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.deleteIncidentRoleAssignment = stubSimpleCall(expectedResponse);
            const [response] = await client.deleteIncidentRoleAssignment(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteIncidentRoleAssignment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteIncidentRoleAssignment without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.deleteIncidentRoleAssignment = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteIncidentRoleAssignment with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteIncidentRoleAssignment = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.deleteIncidentRoleAssignment(request); }, expectedError);
            assert((client.innerApiCalls.deleteIncidentRoleAssignment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('requestIncidentRoleHandover', () => {
        it('invokes requestIncidentRoleHandover without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.RequestIncidentRoleHandoverRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.requestIncidentRoleHandover = stubSimpleCall(expectedResponse);
            const [response] = await client.requestIncidentRoleHandover(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.requestIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes requestIncidentRoleHandover without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.requestIncidentRoleHandover = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes requestIncidentRoleHandover with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.requestIncidentRoleHandover = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.requestIncidentRoleHandover(request); }, expectedError);
            assert((client.innerApiCalls.requestIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('confirmIncidentRoleHandover', () => {
        it('invokes confirmIncidentRoleHandover without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ConfirmIncidentRoleHandoverRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.confirmIncidentRoleHandover = stubSimpleCall(expectedResponse);
            const [response] = await client.confirmIncidentRoleHandover(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.confirmIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes confirmIncidentRoleHandover without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.confirmIncidentRoleHandover = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes confirmIncidentRoleHandover with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.confirmIncidentRoleHandover = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.confirmIncidentRoleHandover(request); }, expectedError);
            assert((client.innerApiCalls.confirmIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('forceIncidentRoleHandover', () => {
        it('invokes forceIncidentRoleHandover without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ForceIncidentRoleHandoverRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.forceIncidentRoleHandover = stubSimpleCall(expectedResponse);
            const [response] = await client.forceIncidentRoleHandover(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.forceIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes forceIncidentRoleHandover without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.forceIncidentRoleHandover = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes forceIncidentRoleHandover with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.forceIncidentRoleHandover = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.forceIncidentRoleHandover(request); }, expectedError);
            assert((client.innerApiCalls.forceIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('cancelIncidentRoleHandover', () => {
        it('invokes cancelIncidentRoleHandover without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.CancelIncidentRoleHandoverRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.cancelIncidentRoleHandover = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelIncidentRoleHandover(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.cancelIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes cancelIncidentRoleHandover without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment());
            client.innerApiCalls.cancelIncidentRoleHandover = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes cancelIncidentRoleHandover with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelIncidentRoleHandover = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.cancelIncidentRoleHandover(request); }, expectedError);
            assert((client.innerApiCalls.cancelIncidentRoleHandover as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('searchIncidents', () => {
        it('invokes searchIncidents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SearchIncidentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchIncidents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchIncidents without error using callback', async () => {
            ...
            client.innerApiCalls.searchIncidents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchIncidents with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchIncidents = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.searchIncidents(request); }, expectedError);
            assert((client.innerApiCalls.searchIncidents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchIncidentsStream without error', async () => {
            ...
            client.descriptors.page.searchIncidents.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchIncidentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.irm.v1alpha2.Incident[] = [];
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Incident) => {
            ...
            assert((client.descriptors.page.searchIncidents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchIncidents, request));
            assert.strictEqual(
        ...
        it('invokes searchIncidentsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.searchIncidents.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchIncidentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.irm.v1alpha2.Incident[] = [];
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Incident) => {
        ...
        it('uses async iteration with searchIncidents without error', async () => {
            ...
            client.descriptors.page.searchIncidents.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.searchIncidents.asyncIterate as SinonStub)
        ...
        it('uses async iteration with searchIncidents with error', async () => {
            ...
            client.descriptors.page.searchIncidents.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchIncidentsAsync(request);
    ...
    describe('searchSimilarIncidents', () => {
        it('invokes searchSimilarIncidents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.Result()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.Result()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.Result()),
            ];
            client.innerApiCalls.searchSimilarIncidents = stubSimpleCall(expectedResponse);
            const [response] = await client.searchSimilarIncidents(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchSimilarIncidents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchSimilarIncidents without error using callback', async () => {
            ...
            client.innerApiCalls.searchSimilarIncidents = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.searchSimilarIncidents(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.IResult[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes searchSimilarIncidents with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchSimilarIncidents = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.searchSimilarIncidents(request); }, expectedError);
            assert((client.innerApiCalls.searchSimilarIncidents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchSimilarIncidentsStream without error', async () => {
            ...
            client.descriptors.page.searchSimilarIncidents.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.Result) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchSimilarIncidents.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchSimilarIncidents, request));
            assert.strictEqual(
                (client.descriptors.page.searchSimilarIncidents.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });
        ...
        it('invokes searchSimilarIncidentsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "name=";
            const expectedError = new Error('expected');
            client.descriptors.page.searchSimilarIncidents.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchSimilarIncidentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.Result[] = [];
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.Result) => {
        ...
        it('uses async iteration with searchSimilarIncidents without error', async () => {
            ...
            client.descriptors.page.searchSimilarIncidents.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchSimilarIncidents.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.searchSimilarIncidents.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with searchSimilarIncidents with error', async () => {
            ...
            client.descriptors.page.searchSimilarIncidents.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchSimilarIncidentsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.irm.v1alpha2.SearchSimilarIncidentsResponse.IResult[] = [];
                for await (const resource of iterable) {
    ...
    describe('listAnnotations', () => {
        it('invokes listAnnotations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ListAnnotationsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Annotation()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Annotation()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Annotation()),
            ];
        ...
        it('invokes listAnnotations with error', async () => {
            ...
            await assert.rejects(async () => { await client.listAnnotations(request); }, expectedError);
            assert((client.innerApiCalls.listAnnotations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listAnnotationsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Annotation) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listTags', () => {
        it('invokes listTags without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ListTagsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('searchSignals', () => {
        it('invokes searchSignals without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.SearchSignalsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchSignals as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchSignals without error using callback', async () => {
            ...
            client.innerApiCalls.searchSignals = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchSignals with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchSignals = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.searchSignals(request); }, expectedError);
            assert((client.innerApiCalls.searchSignals as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes searchSignalsStream without error', async () => {
            ...
            client.descriptors.page.searchSignals.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.searchSignalsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.irm.v1alpha2.Signal[] = [];
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Signal) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchSignals.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchSignals, request));
            assert.strictEqual(
        ...
        it('invokes searchSignalsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.searchSignals.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchSignalsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.irm.v1alpha2.Signal[] = [];
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Signal) => {
        ...
        it('uses async iteration with searchSignals without error', async () => {
            ...
            client.descriptors.page.searchSignals.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchSignals.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.searchSignals.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with searchSignals with error', async () => {
            ...
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";const expectedError = new Error('expected');
            client.descriptors.page.searchSignals.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchSignalsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.irm.v1alpha2.ISignal[] = [];
                for await (const resource of iterable) {
    ...
    describe('listArtifacts', () => {
        it('invokes listArtifacts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ListArtifactsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes listArtifacts with error', async () => {
            ...
            await assert.rejects(async () => { await client.listArtifacts(request); }, expectedError);
            assert((client.innerApiCalls.listArtifacts as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listArtifactsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Artifact) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listSubscriptions', () => {
        it('invokes listSubscriptions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ListSubscriptionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Subscription()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Subscription()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.Subscription()),
            ];
        ...
        it('invokes listSubscriptionsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.Subscription) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
    ...
    describe('listIncidentRoleAssignments', () => {
        it('invokes listIncidentRoleAssignments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.irm.v1alpha2.ListIncidentRoleAssignmentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment()),
              generateSampleMessage(new protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment()),
            ];
            client.innerApiCalls.listIncidentRoleAssignments = stubSimpleCall(expectedResponse);
            const [response] = await client.listIncidentRoleAssignments(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listIncidentRoleAssignments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listIncidentRoleAssignments without error using callback', async () => {
            ...
            client.innerApiCalls.listIncidentRoleAssignments = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listIncidentRoleAssignments with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listIncidentRoleAssignments = stubSimpleCall(undefined, expectedError);
            await assert.rejects(async () => { await client.listIncidentRoleAssignments(request); }, expectedError);
            assert((client.innerApiCalls.listIncidentRoleAssignments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listIncidentRoleAssignmentsStream without error', async () => {
            ...
            client.descriptors.page.listIncidentRoleAssignments.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listIncidentRoleAssignments.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listIncidentRoleAssignments, request));
            assert.strictEqual(
                (client.descriptors.page.listIncidentRoleAssignments.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });
        ...
        it('invokes listIncidentRoleAssignmentsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listIncidentRoleAssignments.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listIncidentRoleAssignmentsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment[] = [];
                stream.on('data', (response: protos.google.cloud.irm.v1alpha2.IncidentRoleAssignment) => {
        ...
        it('uses async iteration with listIncidentRoleAssignments without error', async () => {
            ...
            client.descriptors.page.listIncidentRoleAssignments.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listIncidentRoleAssignments.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.listIncidentRoleAssignments.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with listIncidentRoleAssignments with error', async () => {
            ...
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";const expectedError = new Error('expected');
            client.descriptors.page.listIncidentRoleAssignments.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listIncidentRoleAssignmentsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.irm.v1alpha2.IIncidentRoleAssignment[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('annotation', () => {
            ...
            it('annotationPath', () => {
                const result = client.annotationPath("projectValue", "incidentValue", "annotationValue");
        ...
        describe('artifact', () => {
            ...
            it('artifactPath', () => {
                const result = client.artifactPath("projectValue", "incidentValue", "artifactValue");
                assert.strictEqual(result, fakePath);
        ...
        describe('incident', () => {
            ...
            client.initialize();
            client.pathTemplates.incidentPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.incidentPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('incidentPath', () => {
                const result = client.incidentPath("projectValue", "incidentValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.incidentPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromIncidentName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.incidentPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('incidentRoleAssignment', () => {
            ...
            client.initialize();
            client.pathTemplates.incidentRoleAssignmentPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.incidentRoleAssignmentPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('incidentRoleAssignmentPath', () => {
                const result = client.incidentRoleAssignmentPath("projectIdOrNumberValue", "incidentIdValue", "roleIdValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.incidentRoleAssignmentPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectIdOrNumberFromIncidentRoleAssignmentName', () => {
                const result = client.matchProjectIdOrNumberFromIncidentRoleAssignmentName(fakePath);
                assert.strictEqual(result, "projectIdOrNumberValue");
                assert((client.pathTemplates.incidentRoleAssignmentPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchIncidentIdFromIncidentRoleAssignmentName', () => {
                const result = client.matchIncidentIdFromIncidentRoleAssignmentName(fakePath);
            ...
            it('matchRoleIdFromIncidentRoleAssignmentName', () => {
                const result = client.matchRoleIdFromIncidentRoleAssignmentName(fakePath);
        ...
        describe('signal', () => {
            ...
            client.initialize();
            client.pathTemplates.signalPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.signalPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('signalPath', () => {
                const result = client.signalPath("projectValue", "signalValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.signalPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromSignalName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.signalPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('subscription', () => {
            ...
            it('subscriptionPath', () => {
                const result = client.subscriptionPath("projectValue", "incidentValue", "subscriptionValue");
                assert.strictEqual(result, fakePath);
        ...
        describe('tag', () => {
            ...
            it('tagPath', () => {
                const result = client.tagPath("projectValue", "incidentValue", "tagValue");
                assert.strictEqual(result, fakePath);
